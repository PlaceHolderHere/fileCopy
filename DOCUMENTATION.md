...
# FUNCTIONS
    * copyDir()
        ...
        * Defaults
            ...
            3. by default, copyDir() only performs a file copy when the reference file's last modified time is greater than the output file's last modified time (assuming it exists). If the output file doesn't exist, it performs the copy and creates an output file.
        * Flags
            ...
            3. -a -> copyAll disables default #3 and causes the program to copy all files present in a directory.
        * INPUTS
